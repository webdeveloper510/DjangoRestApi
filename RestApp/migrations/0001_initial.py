    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='RestApp.company')),
            ],
        ),
        migrations.CreateModel(
            name='MasterList',
            fields=[
                ...
                ('Current_Owner', models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, related_name='masterlist_requests_created', to='RestApp.addteam')),
                ('Most_Recent_Owner', models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, related_name='Most_Recent_Owner', to='RestApp.addteam')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teamname', models.ForeignKey(default='', max_length=10, on_delete=django.db.models.deletion.CASCADE, to='RestApp.addteam')),
            ],
        ),
    ]
