...
# Generated by Django 3.1.7 on 2022-04-06 19:47

# Generated by Django 3.1.7 on 2022-04-06 19:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Display_Name_Mini', models.CharField(default='', max_length=100)),
                ('Current_Owner_Short_Name', models.CharField(default='', max_length=100)),
                ('Pick_Status', models.CharField(default='', max_length=100)),
                ('Selected_Player', models.CharField(default='', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Team1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='RestApp.teams')),
                ('Team1_Pick1', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='addtrade_requests_created', to='RestApp.masterlist')),
                ...
                ('Team2', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='addtrade_requests_created', to='RestApp.teams')),
